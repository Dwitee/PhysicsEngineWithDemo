...
protected:
    ...
    mechaEngine::Particle *particleArray;
    mechaEngine::GroundContacts groundContactGenerator;
 ...
 */
 ...
 protected:
    ...
    mechaEngine::Contact contacts[maxContacts];

    /** Holds the collision data structure for collision detection. */
    mechaEngine::CollisionData cData;

    /** Holds the contact resolver. */
    mechaEngine::ContactResolver resolver;
    ...
    virtual void updateObjects(mechaEngine::real duration) = 0;
