 ...
 * @file
 *
 * This file contains the contact resolution system for mechaEngine,
 ...
 * inter-related.
 */
#ifndef MECHAENGINE_CONTACTS_H
#define MECHAENGINE_CONTACTS_H
