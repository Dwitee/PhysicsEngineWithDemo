 ...
 * @file
 *
 * Because mechaEngine is designed to work at either single or double
 ...
 * mechaEngine at a different precision.
 */
#ifndef MECHAENGINE_PRECISION_H
#define MECHAENGINE_PRECISION_H
...
namespace mechaEngine {
    ...
    /**
     * Defines a real number precision. mechaEngine can be compiled in
